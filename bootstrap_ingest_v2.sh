...
# configs/settings.py
# ────────────────────────────────────────────────────────────────────────────────
write src/ingest_v2/configs/init.py ' '
...
# schemas
# ────────────────────────────────────────────────────────────────────────────────
write src/ingest_v2/schemas/init.py \
''
...
# utils
# ────────────────────────────────────────────────────────────────────────────────
write src/ingest_v2/utils/init.py \
''
...
# sources
# ────────────────────────────────────────────────────────────────────────────────
write src/ingest_v2/sources/init.py \
''
...
# ────────────────────────────────────────────────────────────────────────────────
write src/ingest_v2/transcripts/init.py \
''
...
# segmenter
# ────────────────────────────────────────────────────────────────────────────────
write src/ingest_v2/segmenter/init.py \
''
...
# entities
# ────────────────────────────────────────────────────────────────────────────────
write src/ingest_v2/entities/init.py \
''
...
# validators
# ────────────────────────────────────────────────────────────────────────────────
write src/ingest_v2/validators/init.py \
''
...
# pipelines
# ────────────────────────────────────────────────────────────────────────────────
write src/ingest_v2/pipelines/init.py \
''
...
#   tests
# ────────────────────────────────────────────────────────────────────────────────
write src/ingest_v2/tests/init.py \
''
...
segs = build_segments(sentences, duration_s=120.0, parent_id="vid", document_type="youtube_video", clip_base_url="https://www.youtube.com/watch?v=vid")
assert segs
for s in segs:
...
write src/ingest_v2/tests/fixtures/init.py \
''
